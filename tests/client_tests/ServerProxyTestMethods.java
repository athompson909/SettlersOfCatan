...
//    /**
//     * only works when all functions are ran (don't run independently)
//     * the response depends on the state of the server, making it difficult to use an assert statement
//     * @throws ClientException
//     */
//    public void testAddAI() throws ClientException {
//        JSONObject jsonObject = new JSONObject(AI_REQUEST);
//        assertEquals("Success", serverProxy.addAI(jsonObject));
//    }
