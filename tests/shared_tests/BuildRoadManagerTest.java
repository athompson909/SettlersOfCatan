...
public class BuildRoadManagerTest extends TestCase {
    ...
    public void testRoadBuildingManagerNorthEdgeValue(){
    ...
    public void testRoadBuildingManagerNorthWestEdgeValue(){
    ...
    public void testRoadBuildingManagerNorthEastEdgeValue(){
