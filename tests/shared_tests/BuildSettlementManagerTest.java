...
public class BuildSettlementManagerTest extends TestCase {
    ...
    public void testSettlementBuildingManagerNorthWestEdgeVertex() {
        ...
        assert (map.buildSettlementManager.canPlace(PLAYER1, desiredLocation1));
        map.buildSettlementManager.placeSettlement(desiredLocation1, PLAYER1);

        //Space is already occupied
       assert (!map.buildSettlementManager.canPlace(PLAYER1, desiredLocation1));
    }

    public void testSettlementBuildingManagerNorthEastEdgeVertex() {
